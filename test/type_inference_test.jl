...
@testitem "type inference tests : Love Waves" tags = [:inference] begin
    using BenchmarkTools, JET
    velocity_model = [
        [10.0, 7.00, 3.50, 2.00], [10.0, 6.80, 3.40, 2.00], [10.0, 7.00, 3.50, 2.00],
        [10.0, 7.60, 3.80, 2.00], [10.0, 8.40, 4.20, 2.00], [10.0, 9.00, 4.50, 2.00],
    ...
    @inferred LWModel(vs_, h_[1:(end - 1)], density_)
    @inferred forward(m_lw, t)
    @test_opt forward(m_lw, t)
    @test_call forward(m_lw, t)
end
